<?php
/**
 * @version		$Id: document.tpl.php 1018 2009-12-08 12:00:00Z mathias $
 * @category	DOCman
 * @package		DOCman15
...
<h1 class="dm_title"><?php echo _DML_TPL_DETAILSFOR ?><em>&nbsp;<?php echo $this->data->dmname ?></em></h1>
...
if($this->theme->conf->details_name) :
	?>
	<tr>
 		<td><strong><?php echo _DML_TPL_NAME ?>:</strong></td><td><?php echo $this->data->dmname ?></td>
 	</tr>
	<?php
endif;
...
if($this->theme->conf->details_filename) :
	 ?>
 	<tr>
 		<td><strong><?php echo _DML_TPL_FNAME ?>:</strong></td><td><?php echo $this->data->filename ?></td>
 	</tr>
	<?php
endif;
