<?php
/**
 * @version		$Id: list_order.tpl.php 953 2009-10-14 20:38:38Z mathias $
 * @category	DOCman
 * @package		DOCman15
...
*/
?>
<div class="dm_orderby"> 
<?php
	if($this->order->orderby != 'name') :
		?><?php echo _DML_TPL_ORDER_BY ?> : <a href="<?php echo $this->order->links['name'] ?>"><?php echo _DML_TPL_ORDER_NAME ?></a> | <?php
	else :
 		?><strong><?php echo _DML_TPL_ORDER_BY ?> : <?php echo _DML_TPL_ORDER_NAME ?> </strong> | <?php
 	endif;
